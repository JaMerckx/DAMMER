...
def displacement(vertices, triangles, attenuation, kappaopt, sinogram, angles, numpix, edges, trianglesint, atlist, normals, res):
     ...
     for it in range(12):
       ...
       vertgrad = gradoptfun(vertices, triangles, edges, angles, numpix, sinogram, atlist, attenuation, trianglesint, scaleredge1, scaleredge2, areaor)
